...
class PropertyUint;
class CpProxy;
class ICpProxyUpnpOrgRenderingControl1Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyUpnpOrgRenderingControl1Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyUpnpOrgRenderingControl1Cpp : public ICpProxyUpnpOrgRenderingControl1Cpp
{
public:
    /**
     * Constructor.
