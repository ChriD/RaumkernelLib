...
class PropertyUint;
class CpProxy;
class ICpProxyUpnpOrgContentDirectory1Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyUpnpOrgContentDirectory1Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyUpnpOrgContentDirectory1Cpp : public ICpProxyUpnpOrgContentDirectory1Cpp
{
public:
    /**
     * Constructor.
