...
class PropertyUint;
class CpProxy;
class ICpProxyUpnpOrgContentDirectory3Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyUpnpOrgContentDirectory3Cpp() {}
    ...
    virtual void SyncGetServiceResetToken(std::string& aResetToken) = 0;
    virtual void BeginGetServiceResetToken(FunctorAsync& aFunctor) = 0;
    virtual void EndGetServiceResetToken(IAsync& aAsync, std::string& aResetToken) = 0;
    ...
    virtual void SyncFreeFormQuery(const std::string& aContainerID, uint32_t aCDSView, const std::string& aQueryRequest, std::string& aQueryResult, uint32_t& aUpdateID) = 0;
    virtual void BeginFreeFormQuery(const std::string& aContainerID, uint32_t aCDSView, const std::string& aQueryRequest, FunctorAsync& aFunctor) = 0;
    virtual void EndFreeFormQuery(IAsync& aAsync, std::string& aQueryResult, uint32_t& aUpdateID) = 0;
    virtual void SyncGetFreeFormQueryCapabilities(std::string& aFFQCapabilities) = 0;
    virtual void BeginGetFreeFormQueryCapabilities(FunctorAsync& aFunctor) = 0;
    virtual void EndGetFreeFormQueryCapabilities(IAsync& aAsync, std::string& aFFQCapabilities) = 0;
 ...
 * @ingroup Proxies
 */
class CpProxyUpnpOrgContentDirectory3Cpp : public ICpProxyUpnpOrgContentDirectory3Cpp
{
public:
    /**
     * Constructor.
