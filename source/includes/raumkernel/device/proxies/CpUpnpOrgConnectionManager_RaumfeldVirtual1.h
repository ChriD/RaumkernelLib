#ifndef HEADER_UPNPORGCONNECTIONMANAGER_RAUMFELDVIRTUAL1CPP
#define HEADER_UPNPORGCONNECTIONMANAGER_RAUMFELDVIRTUAL1CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyUpnpOrgConnectionManager_RaumfeldVirtual1Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyUpnpOrgConnectionManager_RaumfeldVirtual1Cpp() {}
...
/**
 * Proxy for upnp.org:ConnectionManager_RaumfeldVirtual:1
 * @ingroup Proxies
 */
class CpProxyUpnpOrgConnectionManager_RaumfeldVirtual1Cpp : public ICpProxyUpnpOrgConnectionManager_RaumfeldVirtual1Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyUpnpOrgConnectionManager_RaumfeldVirtual1Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyUpnpOrgConnectionManager_RaumfeldVirtual1Cpp();
     ...
     * CpProxyUpnpOrgConnectionManager_RaumfeldVirtual1Cpp instance will not overlap.
     *
...
#endif // HEADER_UPNPORGCONNECTIONMANAGER_RAUMFELDVIRTUAL1CPP
